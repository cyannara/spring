...
public class BoardController {
	...
	/*
	 * @RequestMapping("/getBoard") public String getBoard(@RequestParam(value="s",
	 * required=false, defaultValue="1") String seq, Model model) {
	 * System.out.println("seq:" + seq); model.addAttribute("board",
	 * boardService.getBoard(seq)); return "board/getBoard"; }
	 */
