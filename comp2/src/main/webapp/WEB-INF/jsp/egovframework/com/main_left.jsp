  ...
  <tr>
    <td width="181" class="title_left" >
		...
		<c:forEach var="result" items="${list_menulist}" varStatus="status" >
			<input type="text" name="tmp_menuNm" value="${result.menuNo}|${result.upperMenuId}|${result.menuNm}|${result.relateImagePath}|${result.relateImageNm}|${pageContext.request.contextPath}/${result.chkURL}|"/>
		</c:forEach>
		</div>
