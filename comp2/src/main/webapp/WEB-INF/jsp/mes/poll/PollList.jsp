...
<%
 /**
  * @Class Name : PollList.jsp
  * @Description : Poll List 화면
...
function fn_egov_select(no) {
	document.getElementById("listForm").no.value = no;
   	document.getElementById("listForm").action = "<c:url value='/poll/updatePollView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/poll/addPollView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/poll/PollList.do'/>";
   	document.getElementById("listForm").submit();
}
