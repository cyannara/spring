...
<%
 /**
  * @Class Name : PollRegister.jsp
  * @Description : Poll Register 화면
...
<c:set var="registerFlag" value="${empty pollVO.no ? '등록' : '수정'}"/>
...
<!-- validator:javascript formName="pollVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/poll/PollList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/poll/deletePoll.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/poll/addPoll.do' : '/poll/updatePoll.do'}"/>";
    frm.submit();
...
<form:form commandName="pollVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
