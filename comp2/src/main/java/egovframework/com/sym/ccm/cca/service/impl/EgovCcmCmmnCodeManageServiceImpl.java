...
public class EgovCcmCmmnCodeManageServiceImpl extends EgovAbstractServiceImpl implements EgovCcmCmmnCodeManageService{
	 ...
	 */
	@Override
	public List<CmmnCode> selectCmmnCodeList(CmmnCodeVO searchVO) throws Exception {
		return (List<CmmnCode>)cmmnCodeManageDAO.selectCmmnCodeList(searchVO);
	}
	...
	@Override
	public List<?> selectCmmmCodeAll(CmmnCodeVO searchVO) throws Exception {
		// TODO Auto-generated method stub
		return cmmnCodeManageDAO.selectCmmmCodeAll(searchVO);
	}
