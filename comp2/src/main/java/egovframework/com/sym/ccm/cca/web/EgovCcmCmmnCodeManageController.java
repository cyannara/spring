...
class GridData {
	List<CmmnCode> updatedRows;
	List<CmmnCode> createRows;
	List<CmmnCode> deletedRows;
}
@Controller
public class EgovCcmCmmnCodeManageController {
	...
	public String selectCmmmCodeAll(CmmnCodeVO searchVO, Model model) throws Exception {
		//model.addAttribute("codeList",
		//		   cmmnCodeManageService.selectCmmmCodeAll(searchVO));
		return "egovframework/com/sym/ccm/cca/EgovCcmCmmnCodeAll";
	}
	
	
	@GetMapping("/ajax/EgovCcmCmmnCodeAll")
	public ModelAndView selectCmmmCodeAllAjax(CmmnCodeVO searchVO, Model model) throws Exception {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("jsonView");
		mv.addObject("codes", cmmnCodeManageService.selectCmmmCodeAll(searchVO));
		return  mv;
	}

	
	@GetMapping("/ajax/EgovCcmCmmnCodeAll2")
	@ResponseBody
	public Map<String,Object> selectCmmmCodeAll2Ajax(CmmnCodeVO searchVO, Model model) throws Exception {
		/*{
			  "result": true,
			  "data": {
			    "contents": [],
		...
		paging.put("totalCount", searchVO.getRecordCountPerPage());
		
		Map<String,Object> data = new HashMap();
		data.put("contents", CmmnCodeList);
